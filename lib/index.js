...
api.isValid = function(ledgerMeta, block, callback) {
  // FIXME: NEED REWORK TO MATCH LATEST SPEC
  // needs to be generalized for documents not blocks/events
  // consensus API will pass in just the guardConfig and the signedDocument
  return callback(new Error('This API Needs to be updated.'));
